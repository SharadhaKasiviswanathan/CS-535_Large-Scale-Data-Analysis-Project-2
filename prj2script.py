    ...
    Steps=[{
        ...
        "HadoopJarStep": {
            ...
            "Args": [
                ...
                "--master", "yarn",
                "--py-files",
                "s3://sharadhakasi/code/project2/prj2.py",
                "s3://sharadhakasi/code/project2/entrypoint2.py",
                
                #"s3://CS535_S3_WORKSPACE/code/prj2.py"  -- to be given while execution
                #"s3://CS535_S3_WORKSPACE/code/entrypoint2.py"
            ],
        },
    }],
)
